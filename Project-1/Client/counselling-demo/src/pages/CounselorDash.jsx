              ...
              <div className='md:w-1/2'>
                <h1  className='relative  text-green-600  md:leading-tight font-bold md:text-5xl'> <em>We Providing Counselling For Mental Health, Relationship And Other psychological Concerns.</em></h1>
                  <div className=' mt-5'>
                    ...
                    <button onClick={()=>{scrollTo({top : 1800,behavior: 'smooth'})}} className='bg-[#E7E8D8] text-xs p-2 md:text-lg md:px-14 md:py-4 rounded-lg md:mt-10 ml-5 md:ml-10'>Get Started</button>
                  </div>
                </div>
              <div>
